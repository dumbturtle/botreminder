...
def manual_add_date_minute(bot: Bot, update: Update, user_data: dict) -> str:
...
def reminder_add_comment(bot: Bot, update: Update, user_data: dict) -> Union[str, ConversationHandler]:
...
def reminder_deleting_list(bot: Bot, update: Update, user_data: dict) -> str:
...
def reminder_confirm_for_delete(bot: Bot, update: Update, user_data: dict) -> str:
...
def reminder_commit_for_delete(bot: Bot, update: Update, user_data:dict) -> ConversationHandler:
...
def reminder_cancel_for_delete(bot: Bot, update: Update, user_data: dict) -> ConversationHandler:
...
def dontknow(bot: Bot, update: Update, user_data: dict) -> ConversationHandler:
